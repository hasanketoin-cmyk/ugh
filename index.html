...
<li class="nav-item">
<a class="nav-link" onclick="showPage('academy')">
⚽
<span>أكاديمية كرة القدم</span>
</a>
</li>

<li class="nav-item">
<a class="nav-link" onclick="showPage('privateTraining')">
🏃
<span>البرايفت</span>
</a>
</li>
...
<button
class="delete"
onclick="deleteAcademyPlayer('${player.docId}')">
